    ...
    return(
            ...
            <div className='flex justify-between w-full flex-wrap items-center py-48'>
                ...
                <div className='w-full flex mb-7 justify-between'>
                    <button className='basis-1/5 mt-3 mx-auto py-2  text-white' onClick={()=>signIn('kakao', {callbackUrl:preUrl })}>
                        <Image src='./sns/kakao_talk.svg' width={50} height={50} alt="naver" className='mx-auto' />
                    </button>
                    <button className='basis-1/5 mt-3 mx-auto py-2  text-white' onClick={()=>signIn('google', {callbackUrl:preUrl})}>
